...
describe('template07 importer test', function () {
  ...
  it('should import single event', function (done) {
    ...
    template07.parseEvents(body, '2015-10-03', function (err, results) {
        ...
        result.should.have.deep.property('categories[0].name', 'Wydarzenie');
  ...
  it('should import single event with time', function (done) {
    var body = '<div class="table"><div class="line hour"><p><span>09:00</span></p></div><div class="event arenad star-wars" data-time-start="13.25" data-time-end="14.5" data-id="933" style="top: 801px; height: 99px; color: rgb(255, 255, 255); background-color: rgb(58, 130, 35);"><div class="event-header"><img class="clock" src="http://komiksfestiwal.com/wp-content/themes/template/img/time.svg" width="10" height="10"><span>17:00-18:00</span></div> <div class="title">Stary i Nowy Kanon - zło ostateczne czy nadzieja na przyszłość? - Mich... </div> </div></div>';
    template07.parseEvents(body, '2015-10-03', function (err, results) {
        //console.dir(err, {depth: null});
        //console.dir(results, {depth: null});
        var result = results[0];
