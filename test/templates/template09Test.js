...
describe('template09 importer test', function () {

  var template09 = require('../../lib/templates/template09');
  ...
  //   template09.parseEvent(21, body, function (err, result) {
  //       console.log(result);
  ...
  //   template09.parseEvent(29, body, function (err, result) {
  //       console.log(result);
