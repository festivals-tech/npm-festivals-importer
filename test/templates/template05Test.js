...
describe('template04 importer test', function () {
  ...
  //      result.should.have.deep.property('description', 'Kitki, zakolanówki, krótkie spódniczki i taniec! Oto składniki potrzebne do stworzenia idealnego show! Zapraszamy na pokaz tańca odottemita w stylu prosto z Kraju Kwitnącej Wiśni~!');
  ...
  it('should import two events', function (done) {
    ...
    template04.parseEvents(body, function (err, results) {
        ...
        first.should.have.deep.property('description', 'Kitki, zakolanówki, krótkie spódniczki i taniec! Oto składniki potrzebne do stworzenia idealnego show! Zapraszamy na pokaz tańca odottemita w stylu prosto z Kraju Kwitnącej Wiśni~!');
        ...
        //second.should.have.deep.property('name', 'Fua Fua Rythm');
        //second.should.have.deep.property('description', 'Kitki, zakolanówki, krótkie spódniczki i taniec! Oto składniki potrzebne do stworzenia idealnego show! Zapraszamy na pokaz tańca odottemita w stylu prosto z Kraju Kwitnącej Wiśni~!');
        ////first.should.have.deep.property('authors[0].name', 'Organizatorzy Polconu 2015');
        //second.should.have.deep.property('minutes', 60);
        //second.should.have.deep.property('duration.startAt', '2015-08-28T18:00:00.000Z');
        //second.should.have.deep.property('duration.finishAt', '2015-08-28T19:00:00.000Z');
